...
class SpeedAndCourseDataTest {
    ...
    private final SpeedAndCourseData speedAndCourseData = new SpeedAndCourseData(Jsoup.parse(HTML).body().getElementsByClass("markerInfo").first());

    @Test
    void getSpeed() {
        assertThat(speedAndCourseData.getSpeed(), is(Double.parseDouble("11.3")));
    }

    @Test
    void getHeading() {
        assertThat(speedAndCourseData.getHeading(), is(Integer.parseInt("112")));
    }
