...
@Component
public class ExportedPositionsResponseFactory {

    private final ExportedPositionResponseFactory exportedPositionResponseFactory;

    public ExportedPositionsResponseFactory(ExportedPositionResponseFactory exportedPositionResponseFactory) {
    ...
    public List<ExportedPositionResponse> toExportedPositionResponse(List<Position> positions) {
        return positions.stream().map(exportedPositionResponseFactory::toExportedPositionResponse).collect(toList());
    }
