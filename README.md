...
I should say that although the code is pretty well structured it does, on occasion, get yacht positions wrong. I need to revisit and redesign this area of the code (see issues).
